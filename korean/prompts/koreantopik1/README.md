...
- Process documented in [extraction/readme.md](extraction/readme.md)
...
- `extraction/readme.md` - Extraction process documentation
- `README.md` - This file

**Not tracked in git:**
- `input/korean-english.tsv` - Base vocabulary file (generated from extraction)
- `extraction/*.csv`, `extraction/*.txt` - Raw extraction files
